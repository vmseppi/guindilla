...
const SeccionTwo = () => {
  return (
    <Box  sx={{display:"flex", flexDirection:"column", height:"457px", alignItems:"center", justifyContent:"space-between", paddingTop:"36px", paddingBottom:"36px", paddingLeft:"16px", paddingRight:"16px" ,  borderBottom: "4px solid red", marginBottom:"20px"}}>
      <img
      ...
      <Box sx={{display:"flex", flexDirection:"column"}}> 
        <Box sx={{marginBottom:"36px", display:"flex", flexDirection:"column"}}>
        <Typography variant="title" sx={{ fontSize: '23px', fontWeight:"bold" }}>Somos La Guindilla</Typography>
        <Typography variant="subtitle" sx={{ fontSize: '12px',fontWeight:"bold" }}>
          Llevamos tus contenidos visuales al siguiente nivel.
        </Typography>
        </Box>
        
        <Typography variant="paragraph" sx={{ fontSize: '14px', fontWeight:"regular" }}>
